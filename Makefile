...
SchShooter: main.o image.o player.o geometry.o items.o bullet.o gameScene.o collision.o
	$(CC) main.o image.o player.o geometry.o items.o bullet.o gameScene.o collision.o -o SchShooter.out $(GLFLAGS) $(CFLAGS)
